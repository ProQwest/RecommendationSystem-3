...
public class SVDModelBuilder implements Provider<SVDModel> {
    ...
    public SVDModel get() {
        ...
        u = u.getSubMatrix(0, u.getRowDimension()-1, 0, featureCount-1);
        RealMatrix v = svd.getV();
        v = v.getSubMatrix(0, v.getRowDimension()-1, 0, featureCount-1);
        ...
        SVDModel model = new SVDModel(userMapping, itemMapping, u, v, s);
